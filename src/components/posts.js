...
const Posts = ({data}) => {
  return (
    <main className="min-h-screen flex flex-col mx-auto max-w-3xl px-4 md:px-0 pt-2">
      <div className="border-b border-color mb-5">
        <h1 className="pb-0 mb-0 text-gray-900 dark:text-gray-200">Personal Hacker News Reader</h1>
